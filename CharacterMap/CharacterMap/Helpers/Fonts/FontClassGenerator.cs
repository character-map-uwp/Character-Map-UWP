...
public class CodeTemplates
{
    public static IReadOnlyList<CodeTemplateOption> Options => field ??= [
        ...
        new("C#", "UWP Markup Extension", CSharpTemplate.MarkupExtension, ".cs"),
    ...
    public static class CSharpTemplate
    {
        ...
        public const string MarkupExtension = """
            ...
            public class {{ClassName}}Glyph : MarkupExtension
            {
                public {{ClassName}}Value Icon { get; set; }

                public static string Get({{ClassName}}Value icon) => char.ConvertFromUtf32((int)icon);
