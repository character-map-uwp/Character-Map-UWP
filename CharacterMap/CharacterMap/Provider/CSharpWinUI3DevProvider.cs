...
{
    public class CSharpWinUI3DevProvider : DevProviderBase
    {
        ...
        protected override DevProviderType GetDevProviderType() => DevProviderType.CSharpWinUI3;
        ...
        IReadOnlyList<DevOption> Inflate()
        {
            ...
            List<DevOption> ops = new()
            {
                ...
                new("TxtFontIcon/Header", $"new FontIcon {{ FontFamily = new Microsoft.UI.Xaml.Media.FontFamily(\"{v?.XamlFontSource}\") , Glyph = \"\\u{hex}\" }};"),
            };

            if (!string.IsNullOrWhiteSpace(pathIconData))
                ops.Add(new DevOption("TxtPathIcon/Text", $"new PathIcon {{ Data = (Microsoft.UI.Xaml.Media.Geometry)Microsoft.UI.Xaml.Markup.XamlBindingHelper.ConvertValue(typeof(Microsoft.UI.Xaml.Media.Geometry), \"{pathIconData}\"), HorizontalAlignment = HorizontalAlignment.Center, VerticalAlignment = VerticalAlignment.Center }};",
