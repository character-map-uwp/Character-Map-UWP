...
namespace CharacterMap.Services
{
    ...
    public static class GlyphService
    {
        ...
        private static IReadOnlyList<string> DefaultTextOptions { get; } = new List<string>
        {
            ...
            "abcdefghijklmnopqrstuvwxyz ABCDEFGHIJKLMNOPQRSTUVWXYZ", // Latin Alphabet
            "абвгдеёжзийклмнопрстуфхцчшщъыьэюя АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ", // Cyrillic Alphabet
            "1234567890.:,; ' \" (!?) +-*/= #@£$€%^& {~¬} [<>] |\\/", // Common Latin symbols and numbers
            ...
            "একজাতীতো সংগঠিত প্রবণতা ও জৈববৈচিত্র্যের কলসী দেখা হয়।", // Bengali
            "ऋषियों को सताने वाले दुष्ट राक्षसों के राजा रावण का सर्वनाश करने वाले विष्णुवतार भगवान श्रीराम, अयोध्या के महाराज दशरथ के बड़े सपुत्र थे।", // Hindi
