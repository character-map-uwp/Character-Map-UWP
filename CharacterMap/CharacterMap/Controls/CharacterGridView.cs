...
public partial class __CharacterGridView : GridView
{
    ...
    public static readonly DP ItemAnnotationProperty = DP<GlyphAnnotation, __CharacterGridView>(GlyphAnnotation.None, (d, o, n) =>
    {
    ...
    {
        public ICharacter Char { get; set; }
        public IFontFace Variant { get; set; }
    ...
    private void OnContainerContentChanging(ListViewBase sender, ContainerContentChangingEventArgs args)
    {
        ...
        if (!args.InRecycleQueue && args.ItemContainer is GridViewItem item)
        {
            ...
            GridViewHelper.UpdateContainer(_xamlDirect, item, _templateSettings, c);
            args.Handled = true;
    ...
    internal static void SetGlyphProperties(CharacterMapCX.Controls.DirectText o, CharacterGridViewTemplateSettings templateSettings, Character c)
    {
        if (o == null)
            return;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void UpdateTypography(XamlDirect xamlDirect, IXamlDirectObject o, ITypographyInfo info)
    {
        GridViewHelper.UpdateTypography(xamlDirect, o, info);
    }
    ...
    void UpdateColorsFonts(bool value)
    {
        ...
        foreach (GridViewItem item in ItemsPanelRoot.Children.OfType<GridViewItem>())
        {
            if (_xamlDirect.GetXamlDirectObject(item.ContentTemplateRoot) is IXamlDirectObject root)
            {
                ...
                GridViewHelper.UpdateColorFont(_xamlDirect, null, tb, value);
            }
        }
    }
    ...
    public void UpdateSize(double value)
    {
        ...
        GridViewHelper.ApplySize(_xamlDirect, this, value);
    }
